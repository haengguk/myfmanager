...
public record CareerLifecycleState(String policyVersion,LocalDate appliedOn,Integer lastReviewedSeason,Map<String,Person> players) {
    ...
    public record Person(Age age,String source,Integer intakeYear,LocalDate introducedOn,int peakCA,LocalDate peakObservedSince,
            ...
            int noAppearanceSeasons,Integer lastReviewYear,String lastCoverage,LocalDate freeAgentSince,LocalDate domesticObservedSince,String observedSquad) {
        public Person{if(observedSquad==null&&domesticObservedSince!=null)observedSquad="FIRST_TEAM";}
        public Person(Age age,String source,Integer intakeYear,LocalDate introducedOn,int peakCA,LocalDate peakObservedSince,Status status,LocalDate announcedOn,LocalDate effectiveOn,String reason,int declineRemainder,int declineCursor,int noAppearanceSeasons,Integer lastReviewYear,String lastCoverage,LocalDate freeAgentSince,LocalDate domesticObservedSince){this(age,source,intakeYear,introducedOn,peakCA,peakObservedSince,status,announcedOn,effectiveOn,reason,declineRemainder,declineCursor,noAppearanceSeasons,lastReviewYear,lastCoverage,freeAgentSince,domesticObservedSince,domesticObservedSince==null?null:"FIRST_TEAM");}
