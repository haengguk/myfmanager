...
public final class CareerRecordsController {
    ...
    @GetMapping("/awards/{instanceId}") public CareerAwardsStore.Award award(@PathVariable String careerId,@PathVariable String instanceId){return records.awardDetail(careerId,instanceId);}
