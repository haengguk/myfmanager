    ...
    public Team createBlueTeam() {
        return new Team(
                ...
                List.of(
                        ...
                        new Player("River", Position.JGL, new PlayerAttributes(15, 16, 13, 16)),
                        ...
                        new Player("Bell", Position.SUP, new PlayerAttributes(13, 11, 8, 17))
                )
        );
    }
    ...
    public Team createRedTeam() {
        return new Team(
                ...
                List.of(
                        ...
                        new Player("Shade", Position.JGL, new PlayerAttributes(15, 16, 13, 15)),
                        ...
                        new Player("Mint", Position.SUP, new PlayerAttributes(13, 11, 8, 17))
                )
        );
    }
}
