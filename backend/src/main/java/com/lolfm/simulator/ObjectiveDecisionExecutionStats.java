...
public final class ObjectiveDecisionExecutionStats {
 private final boolean enabled; private int evaluations,duplicateRejected,initiativeRolls,responderRolls,resets,uncontested,contests,tradeAttempts,tradeSuccesses,tradeFailures;
