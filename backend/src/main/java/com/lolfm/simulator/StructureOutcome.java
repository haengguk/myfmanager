...
public record StructureOutcome(
    ...
    private static StructureActionSource source(PushReason reason){
        return switch(reason){case POST_FIGHT->StructureActionSource.POST_FIGHT;case BARON_PRESSURE->StructureActionSource.BARON_PRESSURE;case MACRO_PLAY->StructureActionSource.MACRO_PLAY;};
    }
}
