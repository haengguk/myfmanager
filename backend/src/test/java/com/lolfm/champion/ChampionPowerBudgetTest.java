...
class ChampionPowerBudgetTest {
    @Test void standardizedWeightsAreUnitAndAllFullProfilesAreAuditedWithoutMutation() {
        ...
        assertThat(audit.champions()).hasSize(173); assertThat(audit.positions()).hasSize(5); assertThat(profiles.all()).containsExactlyElementsOf(before);
    }
}
