...
const SAFE_COPY: Readonly<Record<string, string>> = {
  ...
  CAREER_SAVE_COMPATIBILITY_DATA_MISSING: '저장에 필요한 선수·시즌 원본이 없습니다. 생성 당시 자료가 보존된 저장에서 복구해야 합니다.',
  CAREER_SAVE_COMPATIBILITY_VERSION_UNSUPPORTED: '지원하지 않는 저장 명부 형식입니다. 해당 저장 형식을 지원하는 버전이 필요합니다.',
  CAREER_SAVE_COMPATIBILITY_ORGANIZATION_UNSUPPORTED: '저장된 관리 구단 정의가 없어 연결할 수 없습니다. 원래 조직 정의가 필요합니다.',
...
import type { TradeCommand } from './careerManagement.contract';
