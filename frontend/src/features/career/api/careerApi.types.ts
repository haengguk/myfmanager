...
export type CareerCompetitionRuleStatus = 'RULE_SOURCE_COMPLETE' | 'RULE_SOURCE_INCOMPLETE' | 'PRODUCT_POLICY_REQUIRED';
export interface CareerCompetitionSummaryDto { competitionId: string; stageId: string; ruleStatus: CareerCompetitionRuleStatus; lifecycleStatus: string; blockingReason: string | null; revision: number; stateHash: string; completedFixtures: number; totalFixtures: number }
