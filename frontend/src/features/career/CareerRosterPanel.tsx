...
const reasonName = (s: string | null) => s ? ({ AFFILIATION_UNCONFIRMED: '소속 미확인', NO_COMPETITIVE_TEAM: '실행 대상 경쟁 팀 없음', UNAFFILIATED_SIGNING_NOT_IMPLEMENTED: '무소속 · 게임 계약 시장에서 확인' }[s] ?? '현재 소속으로 출전할 수 없음') : null;
